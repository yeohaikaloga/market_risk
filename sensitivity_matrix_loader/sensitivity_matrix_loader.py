...
class SensitivityMatrixLoader():
    ...
    def __init__(self, cob_date: str, product: str, source: str):
    ...
    def load_sensitivity_matrix(self) -> pd.DataFrame:
        ...
        with self.source.connect() as conn:
            if self.product == 'cotton':
                ...
                if json_string:
                    print(f"Success: Found sensitivity matrix for {self.product} on {self.cob_date}.")
                ...
                if json_string_rba:
                    print(f"Success: Found sensitivity matrix for Non-China rubber on {self.cob_date}.")
                    df_rba = pd.read_json(json_string_rba)
                else:
                    print(f"Warning: No sensitivity report found for Non-China rubber on {self.cob_date}.")
                ...
                if json_string_rbc:
                    print(f"Success: Found sensitivity matrix for China rubber on {self.cob_date}.")
                    df_rbc = pd.read_json(json_string_rbc)
                else:
                    print(f"Warning: No sensitivity report found for China rubber on {self.cob_date}.")
            ...
            print(f"Total rows in {self.product} sensitivity matrix: {len(df)}")
            return df
